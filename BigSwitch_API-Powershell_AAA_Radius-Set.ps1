...
$params2=@{
  "secret"= "695c5e552b79257b646620415345025206080f06025b54"
...
$tenant_segment_interface="https://"+$IP +":8443/api/v1/data/controller/core/aaa/radius/server[server-address=" + '"' + $RADIUS + '"' + "]"
